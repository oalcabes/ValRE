...
#CONFIGURATION FILE - EDIT THIS VALUES BEFORE RUNNING ValRE
...
#If you do not have dates specified in the names of your model files, ValRE will NOT
...
#threshold(s) (in pfu)
pfu_threshold = [10,1]
#probabilistic threshold (ONLY ONE VALUE FOR ALL THRESHOLDS)
prob_threshold = 0.25
...
#and both can be marked False if you'd like none (although you probably want one
#otherwise idk why you're running this).
...
#OTHER NOTES: if no_mod_file = 'all_clear', not having model files for a given event
